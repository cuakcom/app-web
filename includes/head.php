...
<head>
    ...
    <title>Check Berry - Analizador DNS, SSL, Correo y Web</title>
    <meta name="description" content="Check Berry: Suite profesional de herramientas para análisis de dominios, DNS, correo electrónico, SSL/TLS y diagnóstico web.">
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Check Berry - Analizador DNS, SSL, Correo y Web">
    ...
    <meta property="og:site_name" content="Check Berry">
    <meta property="og:locale" content="es_ES">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Check Berry - Analizador DNS, SSL, Correo y Web">
